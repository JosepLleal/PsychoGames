...
bool ModuleLevel5::Start()
{
	...
	App->collision->AddCollider({ 2400, 238, 17, 18 }, COLLIDER_WALL);
	...
	App->collision->AddCollider({ 2406, 120, 2, 60 }, COLLIDER_NONE);
	...
	App->enemies->AddEnemy(ENEMY_TYPES::YELLOWBALL, 2430, 202);
	App->enemies->AddEnemy(ENEMY_TYPES::YELLOWBALL, 2460, 202);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2515, 88);
	App->collision->AddCollider({ 2526, 120, 2, 40 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2500, 130);
	App->enemies->AddEnemy(ENEMY_TYPES::YELLOWBALL2, 2520, 20);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL, 2660, 35);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL2, 2667, 30);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL3, 2710, 110);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2675, 40);
	App->collision->AddCollider({ 2678, 80, 2, 40 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::YELLOWBALL, 2660, 202);

	//second 3 diamond together 
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2736, 60);
	App->collision->AddCollider({ 2736, 60, 2, 60 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2768, 60);
	App->collision->AddCollider({ 2768, 60, 2, 45 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2800, 60);
	App->collision->AddCollider({ 2800, 60, 2, 30 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2721, 62);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL, 2753, 66);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2786, 66);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2725, 60);

	//third 3 diamond together
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2896, 70);
	App->collision->AddCollider({ 2896, 70, 2, 50 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2928, 60);
	App->collision->AddCollider({ 2928, 70, 2, 35 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::DIAMOND_WALL, 2960, 60);
	App->collision->AddCollider({ 2960, 70, 2, 20 }, COLLIDER_NONE);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL, 2881, 110);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2913, 66);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL1, 2946, 60);

	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL4, 2990, 65);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL, 2992, 75);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBALL2, 3000, 100);
